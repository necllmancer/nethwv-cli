...
func FetchFileContent(fileURL string) (string, error) {
	if !isTextFile(fileURL) {
		return "", nil // Return empty string for non-text files
	}
...
func isTextFile(url string) bool {
	textExtensions := []string{
		".txt", ".md", ".xml", ".json", ".yaml", ".yml", ".csv", ".tsv", ".ini", ".cfg", ".conf", ".properties", ".log", ".rtf", ".tex", ".html", ".htm", ".xhtml", ".css", ".scss", ".sass", ".less", ".js", ".mjs", ".jsx", ".ts", ".tsx", ".sql", ".graphql", ".gql", ".sh", ".bash", ".zsh", ".bat", ".cmd", ".ps1", ".vbs", ".rb", ".erb", ".py", ".pyw", ".r", ".pl", ".php", ".phtml", ".jsp", ".asp", ".aspx", ".cgi", ".lua", ".swift", ".go", ".java", ".class", ".jar", ".c", ".cpp", ".cc", ".cxx", ".h", ".hpp", ".hxx", ".cs", ".vb", ".f", ".f90", ".f95", ".rkt", ".clj", ".cljs", ".cljc", ".groovy", ".gvy", ".kt", ".kts", ".m", ".pas", ".d", ".scala", ".sbt", ".rs", ".elm", ".ex", ".exs", ".eex", ".hx", ".nim", ".b", ".bf", ".v", ".sv", ".svh", ".vhd", ".vhdl", ".ucf", ".qsf", ".asm", ".s", ".agc", ".ags", ".aea", ".sed", ".awk", ".ps", ".eps", ".jsonld", ".webmanifest", ".toml", ".bowerrc", ".npmrc", ".dockerignore", ".gitignore", ".editorconfig", ".prettierrc", ".sol", ".au3", ".nsh", ".nsl", ".lua", ".mak", ".sln", ".vcxproj", ".csproj", ".fsproj", ".xproj", ".dproj", ".lpr", ".gpr", ".uproject", ".pbxproj", ".svg", ".tcl", ".exp", ".brs", ".wren",
